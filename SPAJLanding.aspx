<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SPAJLanding.aspx.vb" Inherits="WebApplication11.SPAJModule1" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html>

<title>SPAJ LANDING</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<link href="Styles/SPAJLanding.css" rel="stylesheet" type="text/css" />
...
<body>
 ...
 <div id="ContentContainer">
    ...
    <div class="ButtonImageContainer">
     <p style="color: #FFFFFF; text-align: center; top: 200px; font-size: xx-large; font-weight: bold; font-style: normal; text-decoration: none;">E-SPAJ Module</p>
    ...
    <br>
         ...
         <input type="button" id="buttonAddNew" class="ButtonImageRight" value="Add New" onclick="return buttonAddNew_onclick()" />
